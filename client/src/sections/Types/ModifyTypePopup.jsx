...
import {ModifyTypeQueriesContext} from "./ModifyType/ModifyTypeQueriesContext"
...
function ModifyTypePopup (props) {
  ...
  const modifyTypeQueries = useContext(ModifyTypeQueriesContext)/////////////////////////////////////////////////////////////////////////////
  ...
  const changeName = (name) => {
    if (modalState.name !== name) {
      ...
      setModalState((prevState) => ({ ...prevState, name: name}))
    }
  }
  ...
  },[props.name, props.visible, props.type, props.typesList, init, typeFieldsList, socket, addMessage, query, modalState.type])
